...
python eh facil, usa identacao obrigatoria pra
alinhar blocos de codigos em vez de chaves{}

este codigo tambem nos ajudara a criar o nosso original
'''
btree.py
import bisect
import itertools
...
if __name__ == '__main__':
    unittest.main()
@majegozo
majegozo commented on 3 Jul 2013
